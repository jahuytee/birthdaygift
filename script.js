...
const CONSTELLATIONS = [
  {
    ...
    stars: [
      { x: 10.6, y: 27.9 }, { x: 22.4, y: 29.0 },
      { x: 11.7, y: 35.8 }, { x: 23.5, y: 36.9 },
      { x: 12.8, y: 42.5 }, { x: 24.6, y: 43.6 },
      { x: 21.3, y: 45.9 }, { x: 18.1, y: 48.1 }, { x: 14.9, y: 50.4 },
      { x: 8.5, y: 63.3 }, { x: 28.8, y: 65.0 },
      { x: 6.9, y: 23.4 }, { x: 3.1, y: 19.4 }, { x: 5.3, y: 14.4 }, { x: 1.0, y: 11.0 },
      { x: 28.3, y: 26.8 }, { x: 33.1, y: 23.9 }, { x: 37.4, y: 26.8 }, { x: 39.0, y: 31.8 },
    ],
    edges: [
      [0, 1], [0, 2], [1, 3], [2, 4], [3, 5],
      [4, 8], [5, 6], [8, 7], [7, 6], [8, 9], [6, 10],
