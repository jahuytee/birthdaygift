...
const CONSTELLATIONS = [
  {
    ...
    stars: [
      { x: 12.0, y: 27.3 }, { x: 23.0, y: 28.6 },
      { x: 17.5, y: 22.4 }, { x: 14.5, y: 15.5 }, { x: 20.5, y: 15.5 },
      { x: 20.5, y: 41.1 }, { x: 18.0, y: 43.9 }, { x: 15.5, y: 46.7 },
      { x: 26.0, y: 64.0 }, { x: 11.0, y: 61.9 },
      { x: 7.0, y: 20.3 }, { x: 2.0, y: 12.0 },
      { x: 29.5, y: 25.9 }, { x: 33.0, y: 21.7 }, { x: 36.0, y: 18.9 }, { x: 38.0, y: 24.5 },
    ],
    edges: [
      [9, 7], [7, 0], [0, 1], [1, 5], [5, 8],
      [5, 6], [6, 7],
